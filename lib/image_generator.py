...
def createlabel(classlist,labelpath):
    print("Creating labelfile")
...
class ImageGenerator():
    def __init__(self, item_path, background_path,labelfile="",split_class=""):
        ...
        if labelfile != "":
            createlabel(self.class_lst,labelfile)
